	...
	.object({
		...
		password: z
			...
			.regex(/^(?=.*[A-Za-z])(?=.*\d)(?=.*[@$!%*#?&])[A-Za-z\d@$!%*#?&]{8,}$/, {
				message:
					'Password must be a minimum of 8 characters & contain least one letter, one number and one special character.'
			}),
		passwordConfirm: z
...
export const createProjectSchema = z.object({
	...
	tagline: z
		...
		.min(1, { message: 'Tagline must have at least 1 character' })
